...
def More(message):
    bot.send_message(message.chat.id, 
"""🔍 More information:
1. programming languages: Python, Java, C++, etc - top 100 languages 
[https://www.bairesdev.com/blog/top-programming-languages/]

2. data analysis tools: SQL, Excel, R, Python 
[https://www.coursera.org/articles/data-analysis-tools]

3. web development frameworks: React, Angular, Vue.js 
[https://www.sencha.com/blog/web-application-development-top-frameworks/]

4. DevOps tools: Docker, Kubernetes, Jenkins  
[https://www.redhat.com/en/topics/devops/what-is-devops]

5. project management methodologies: Agile, Scrum, Waterfall  
